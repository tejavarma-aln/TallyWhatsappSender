        ...
        public String InitProcess(String contact,String file_route,String title,String time_wait)
        {
            try
            {
                ...
                try
                {
                    ...
                    wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementIsVisible(By.CssSelector("span[data-icon='clip']")));
                }
                catch (WebDriverTimeoutException)
                {
                    if (!(chrome_driver is null)) chrome_driver.Quit();
                    return "Invalid Contact Number or Error Occurred";
                }
                ...
                Thread.Sleep(1000);
                IWebElement typebox = chrome_driver.FindElements(By.CssSelector("div[contenteditable ='true']"))[1];
